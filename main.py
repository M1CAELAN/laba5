...
class Calculator(QWidget):
    ...
    def _operation(self, op):
        if self.input.text() == "":
            QMessageBox.about(self, "Error", "цыферки напиши")
        elif re.findall(r'\D', self.input.text()) and re.findall(r'\.', self.input.text()) == []:
    ...
    def _result(self):
        try:
            ...
            QMessageBox.about(self, "Error", "хули равно дорочишь?")
